    ...
    <div class="col-xs-12">
        <div class="widget-box">
            ...
            <div class="widget-body">
                ...
                <form class="form-horizontal" id="validation-form" method="POST" action="{{ route('student_save') }}">
                    @csrf
                    <div class="widget-main">
                        <div class="form-group">
                            ...
                            <div class="col-xs-12 col-sm-9">
                                <div class="clearfix">
                                    <input type="text" name="name" id="name" class="col-xs-12 col-sm-6" placeholder="Name Of Student"/>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-12 col-sm-9">
                                <div class="clearfix">
                                    <input data-date-format="yyyy-mm-dd" type="text" name="dob" id="dob" class="col-xs-12 col-sm-4 date-picker" placeholder="Date Of Birth"/>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-12 col-sm-9">
                                <div class="clearfix">
                                    <input type="text" name="city" id="city" class="col-xs-12 col-sm-4" placeholder="City Of Student"/>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="modal-footer wizard-actions">
                        <a class="btn btn-sm btn-warning btn-prev" href="{{ route('student_add') }}">
