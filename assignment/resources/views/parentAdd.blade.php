    ...
    <div class="col-xs-12">
        <div class="widget-box">
            ...
            <div class="widget-body">
                ...
                <form class="form-horizontal" id="validation-form" method="POST" action="{{ route('parent_save') }}">
                    @csrf
                    <div class="widget-main">
                        <div class="form-group">
                            ...
                            <div class="col-xs-12 col-sm-9">
                                <div class="clearfix">
                                    <input type="text" name="name" id="name" class="col-xs-12 col-sm-6" placeholder="Name Of Parent"/>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="modal-footer wizard-actions">
                        <a class="btn btn-sm btn-warning btn-prev" href="{{ route('parent_add') }}">
