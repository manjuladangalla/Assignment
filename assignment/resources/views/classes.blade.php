...
<div class="row">
    ...
    <div class="col-xs-12">
        <div class="pull-right">
            <a class="btn btn-sm btn-primary" href="{{ route('class_add') }}">Add New Class</a>
        </div>
    </div>
    @endcan
</div>
            ...
            <tr>
                ...
                <td>
                    <div class="hidden-sm hidden-xs btn-group">
                        <a href="{{ route('class_view', $class->id ) }}" class="btn btn-xs btn-success">
                            <i class="ace-icon fa fa-check bigger-120"></i>
                        </a>
                        @can('isAdmin')
                        <a href="{{ route('class_edit', $class->id ) }}" class="btn btn-xs btn-info">
                            <i class="ace-icon fa fa-pencil bigger-120"></i>
                        </a>

                        <a href="{{ route('class_delete', $class->id ) }}" class="btn btn-xs btn-danger">
                    ...
                    <div class="hidden-md hidden-lg">
                        <div class="inline pos-rel">
                            ...
                            <ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
                                <li>
                                    <a href="{{ route('class_view', $class->id ) }}" class="tooltip-info" data-rel="tooltip" title="View">
                                        <span class="blue">
                                ...
                                @can('isAdmin')
                                <li>
                                    <a href="{{ route('class_edit', $class->id ) }}" class="tooltip-success" data-rel="tooltip" title="Edit">
                                        <span class="green">
                                ...
                                <li>
                                    <a href="{{ route('class_delete', $class->id ) }}" class="tooltip-error" data-rel="tooltip" title="Delete">
                                        <span class="red">
                                            <i class="ace-icon fa fa-trash-o bigger-120"></i>
                                        </span>
                                    </a>
